...
USEFORM("TreeConstructor.cpp", TreeConstructorForm);
...
WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
     ...
     Application->CreateForm(__classid(TFPSaveForm), &FPSaveForm);
     Application->Run();
